...
A tiny dataset containing estimates of global coffee in thousands of 60
kg bags produced by country. Purpose: teaching \*\*not\*\* research.
...
The examples section shows how this can be joined with spatial data to
create a simple map.
